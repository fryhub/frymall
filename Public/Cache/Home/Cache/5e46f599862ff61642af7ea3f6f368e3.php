...
<div class="container">
	<div class="mainwidth">
		...
		<div id="product-list">
			<ul class="prolist" id="akmall-category">
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="li_on">
					<div class="img">
						<a href="<?php echo U('Index/order',array('id'=>$vo['sn']));?>" title="<?php echo ($vo["name"]); ?>"><img src="<?php echo (imageurl($vo["image"])); ?>"  class="akmall-lazy"><span></span></a>
					</div>
					<span class="textcon">
						...
						<a href="<?php echo U('Index/order',array('id'=>$vo['sn']));?>" title="<?php echo ($vo["name"]); ?>" class="line_a"><?php echo lang('detail');?></a>
					</span>
