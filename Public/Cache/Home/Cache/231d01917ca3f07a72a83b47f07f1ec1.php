...
<title>AK单页订单管理系统企业版 - 123456</title>
...
<div class="header">
<div class="head">
<div class="logo"><a href="http://123456" target="_blank"><img src="__PUBLIC__/Assets/img/akmall-logo.png" alt="AK单页订单管理系统企业版" /></a></div>
<div class="menu">AK单页订单管理系统企业版安装 - 123456</div>
</div>
</div>
...
<form action="index.php?m=Install&a=setup" method="post">
	...
	<table class="form-table">
		...
		<tr>
			...
			<td width="200"><input type="text" value="127.0.0.1" size="25" id="dbhost" name="DB[DB_HOST]"></td>
			<td>通常为 <code>127.0.0.1/localhost</code>，若测试连接失败，请联系主机提供商咨询。</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="text" value="akmall" size="25" id="dbname" name="DB[DB_NAME]"></td>
			<td>若数据库不存在，将自动创建</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="text" size="25" value="ak<?php echo randCode(3);?>_" id="prefix" name="DB[DB_PREFIX]"></td>
...
<p>请在下面输入网站后台管理员信息</p>
	...
	<table class="form-table">
		<tbody>
			...
			<tr>
				...
				<td><input type="text" value="12345678" size="25" name="ADMIN[pwd]"></td>
				<td>您的登录密码</td>
			</tr>
	...
	<p class="step">
		<input type="hidden" value="<?php echo ($root); ?>" name="DB[akmall_ROOT]">
...
﻿<!--footer-->
<div class="footer">Powered by AK单页订单管理系统企业版（<a href="http://123456" target="_blank">123456</a>）</div>
</body>
</html>