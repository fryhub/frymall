...
<meta charset="utf-8" />
<title>用户登陆</title>
<meta name="Author" content="123456">
<meta name="Version" content="<?php echo C('AKMALL_VERSION');?>">
...
<div id="header">
	<div class="w-980 clearfix">
    	<div class="logo"><a href="http://<?php echo ($_SERVER['HTTP_HOST']); ?>" style="color:#fff;font-size:25px;"><img src="__PUBLIC__/Assets/img/akmall-logo.png" height="35"></a></div>
    </div>
</div>
...
var url="<?php echo U('Public/getVersion');?>";
$(function(){$.get(url);})
</script>
</body>
</html>