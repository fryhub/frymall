                ...
                <table cellpadding="0" cellspacing="0" width="100%" >
                    <thead>
                        <tr class="ui-table-head">
                            ...
                            <th class="ui-table-hcell" width="40"><?php echo lang('id');?></th>
                            <th class="ui-table-hcell"><?php echo lang('username');?></th>
                            <th class="ui-table-hcell"><?php echo lang('realname');?></th>
                    ...
                    <tbody>
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="row-<?php echo ($vo["id"]); ?>">
                            ...
                            <td class="action">
								...
								<?php if(($vo["id"]) == "1"): ?><q onclick="javascript:;" class="grey"><?php echo lang('delete');?></q>
								<?php else: ?>
								<q onclick="javascript:Delete('<?php echo ($vo["id"]); ?>','<?php echo U('User/proccess/',array('do'=>'delete','id'=>$vo['id']));?>')"><?php echo lang('delete');?></q><?php endif; ?>
                            </td>
