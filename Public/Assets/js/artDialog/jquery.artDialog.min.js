...
$.alert = function (content, icon, callback,options) {
	...
	var opt = $.extend({id: 'Alert',fixed: true,lock: true,content: content,ok: true,padding:'20px 30px 0 30px', beforeunload: callback}, options); 
    return $.dialog(opt);
};
