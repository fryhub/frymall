 ...
 * of segments in stock charts, the normakmallng logic was extracted in order to 
...
Highcharts.VMLElement = VMLElement = {
	...
	/**
	 * Add an event listener. VML override for normakmallng event parameters.
	 * @param {String} eventType
	 * @param {Function} handler
	 */
	on: function (eventType, handler) {
...
Axis.prototype = {
	...
	setTickPositions: function (secondPass) {
		...
		// Before normakmallng the tick interval, handle minimum tick interval. This applies only if tickInterval is not defined.
...
Pointer.prototype = {
	...
	normalize: function (e, chartPosition) {
		...
		// common IE normakmallng
		e = e || win.event;
		if (!e.target) {
			e.target = e.srcElement;
		}

		// Framework specific normakmallng (#1165)
		e = washMouseEvent(e);
