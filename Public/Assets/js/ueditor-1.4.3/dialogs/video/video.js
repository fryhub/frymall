...
(function(){
    ...
    function initVideo(){
        ...
        (function(){
            ...
            if(img && img.className){
                ...
                if(hasFakedClass || hasUploadClass || url) {
    ...
    function createPreviewVideo(url){
		 ...
		 * AK单页订单管理系统企业版
		 */
		var ext = conUrl.toLowerCase().split('.').splice(-1);
		var video = '',width='100%',height='350';
		if(ext=='mp4'){
			video = '<video style="width: ' + width  + ';height:' + height  + ';" controls="true"><source src="' + conUrl + '" type="video/mp4"/>Your browser does not support HTML5 video.<ideo></ideo></video>';
		}else{
			video = '<div class="previewMsg"><span>'+lang.urlError+'</span></div>'+
