...
function U($url='',$vars='',$suffix=true,$redirect=false,$domain=false) {
    ...
    if(C('akmall_ROUTE')==true && C('URL_MODEL')==2){
         $uri = akmall_URL($url,$vars);
         if($uri){
			if(count($vars)>1){
